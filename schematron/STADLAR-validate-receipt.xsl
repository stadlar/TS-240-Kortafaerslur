...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ts240-card-transaction-rules</xsl:attribute>
            <xsl:attribute name="name">ts240-card-transaction-rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <xsl:param name="profile"
              select="       if (/*/cbc:ProfileID and matches(normalize-space(/*/cbc:ProfileID), 'urn:fdc:stadlar.is:ts240:1.0')) then         tokenize(normalize-space(/*/cbc:ProfileID), ':')[5]       else         'Unknown'"/>
   ...
   <xsl:template match="ubl-creditnote:CreditNote | ubl-invoice:Invoice"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$profile != 'Unknown'">
               ...
               <svrl:text>Business process MUST be in the format 'urn:fdc:stadlar.is:ts240:1.0' </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:fdc:stadlar.is:kort:1.0')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:fdc:stadlar.is:kort:1.0')">
               <xsl:attribute name="id">PEPPOL-EN16931-R004</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Specification identifier MUST have the value 'urn:fdc:stadlar.is:kort:1.0'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN ts240-card-transaction-rules-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rules for Staðlaráð TS240 card transactions (kortafærslur)</svrl:text>
   ...
   <xsl:template match="ubl-invoice:Invoice | ubl-creditnote:CreditNote"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="normalize-space(cbc:InvoiceTypeCode) = '461' or normalize-space(cbc:CreditNoteTypeCode) = '461'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="normalize-space(cbc:InvoiceTypeCode) = '461' or normalize-space(cbc:CreditNoteTypeCode) = '461'">
               <xsl:attribute name="id">TS240-R-001</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-001]-Document type code (BT-3) MUST be 461 for card transactions — Tegundarkóti skjals (BT-3) skal vera 461 fyrir kortafærslur.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="(exists(cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID) or exists(cac:TaxRepresentativeParty)) or not((//cac:TaxCategory/cbc:ID | //cac:ClassifiedTaxCategory/cbc:ID)[normalize-space(.) != 'O'])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(exists(cac:AccountingSupplierParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID) or exists(cac:TaxRepresentativeParty)) or not((//cac:TaxCategory/cbc:ID | //cac:ClassifiedTaxCategory/cbc:ID)[normalize-space(.) != 'O'])">
               <xsl:attribute name="id">TS240-R-008</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="normalize-space(cac:OrderReference/cbc:ID) != ''"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="normalize-space(cac:OrderReference/cbc:ID) != ''">
               <xsl:attribute name="id">TS240-R-010</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-010]-The fintech reference (BT-13, cac:OrderReference/cbc:ID) is missing; it is mandatory for card transactions — Tilvísun fjártækniaðila (BT-13, cac:OrderReference/cbc:ID) vantar; hún er skylda fyrir kortafærslur.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M43"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cac:PaymentMeans" priority="1004" mode="M43">
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(cbc:PaymentMeansCode/@name) or contains(' MANUAL MAGSTRIPE CHIP CONTACTLESS ECOMMERCE MOTO STORED ', concat(' ', normalize-space(cbc:PaymentMeansCode/@name), ' '))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cbc:PaymentMeansCode/@name) or contains(' MANUAL MAGSTRIPE CHIP CONTACTLESS ECOMMERCE MOTO STORED ', concat(' ', normalize-space(cbc:PaymentMeansCode/@name), ' '))">
               <xsl:attribute name="id">TS240-R-011</xsl:attribute>
               <xsl:attribute name="flag">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-011]-POS entry mode (BT-82, cbc:PaymentMeansCode/@name), if given, should be one of MANUAL, MAGSTRIPE, CHIP, CONTACTLESS, ECOMMERCE, MOTO, STORED — Uppruni færslu (BT-82), ef tilgreint, ætti að vera eitt af MANUAL, MAGSTRIPE, CHIP, CONTACTLESS, ECOMMERCE, MOTO, STORED.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M43"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cac:LegalMonetaryTotal" priority="1003" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cac:LegalMonetaryTotal"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="cbc:PayableAmount castable as xs:decimal and xs:decimal(cbc:PayableAmount) = 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cbc:PayableAmount castable as xs:decimal and xs:decimal(cbc:PayableAmount) = 0">
               <xsl:attribute name="id">TS240-R-003</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-003]-Amount due for payment (BT-115) MUST be zero for card transactions — Greiðsluupphæð (BT-115) skal vera núll fyrir kortafærslur.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M43"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cac:LegalMonetaryTotal/cbc:LineExtensionAmount | cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount | cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount | cac:LegalMonetaryTotal/cbc:PrepaidAmount | cac:TaxTotal/cbc:TaxAmount"
                 priority="1002"
                 mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cac:LegalMonetaryTotal/cbc:LineExtensionAmount | cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount | cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount | cac:LegalMonetaryTotal/cbc:PrepaidAmount | cac:TaxTotal/cbc:TaxAmount"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(@currencyID = 'ISK') or (. castable as xs:decimal and xs:decimal(.) = round(xs:decimal(.)))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(@currencyID = 'ISK') or (. castable as xs:decimal and xs:decimal(.) = round(xs:decimal(.)))">
               <xsl:attribute name="id">TS240-R-004</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-004]-Document total amounts in ISK (BT-106, BT-109, BT-110, BT-112, BT-113) MUST NOT have decimals — Heildarfjárhæðir skjals í ISK (BT-106, BT-109, BT-110, BT-112, BT-113) skulu ekki hafa aukastafi.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M43"/>
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:EmbeddedDocumentBinaryObject" priority="1001" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cbc:EmbeddedDocumentBinaryObject"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="string-length(normalize-space(.)) &lt;= 5242880"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="string-length(normalize-space(.)) &lt;= 5242880">
               <xsl:attribute name="id">TS240-R-005</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-005]-Attached document (BT-125) MUST NOT exceed 5 MB of base64 content — Viðhengt skjal (BT-125) skal ekki vera stærra en 5 MB af base64 gögnum.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="string-length(@filename) &lt;= 255"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="string-length(@filename) &lt;= 255">
               <xsl:attribute name="id">TS240-R-006</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[TS240-R-006]-Attached document file name (BT-125-2) MUST NOT exceed 255 characters — Skráarnafn viðhengis (BT-125-2) skal ekki vera lengra en 255 stafir.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*" mode="M43"/>
