...
- `examples/` — átta tilbúnar kvittanir, ein fyrir hverja sviðsmynd, sem allar standast án villu:
  ...
  - `…-foreign-merchant` — erlendur seljandi, upphaflega upphæðin skráð í tilteknum reit.
...
- **ARN (acquirer reference number)** — tilvísunarnúmer kortafærslunnar á sér engan ákveðinn reit í
...
- **Hvernig kortið var notað** (uppruni færslu) er valfrjálst, en ef það er tilgreint ætti það að vera
...
- **Formfesta uppruna-færslu-reitinn og gildalistann** í forskriftinni (í dag er þetta valfrjáls
  athugun sem gefur aðeins viðvörun).
...
| TS240-R-011 | uppruni færslu, ef tilgreindur, sé eitt af stöðluðu gildunum | Viðbótarkrafa | Viðvörun |
...
| BT-82 — Uppruni færslu (POS entry) | TS240-R-011 (viðvörun) | viðbót |
